                ...
                <Box as='form'>
                    <Box as='fieldset' border='none' mt='3.5rem'>
                        ...
                        <Box as='div'>
                            ...
                            <Input type="text" fontWeight='500' backgroundColor='#FCFDFF' border='1px solid #E1E3E6' borderRadius='0.313rem' padding='0.75rem 1.5rem' width='100%' color='#5A5A66'></Input>
                        </Box>
                        ...
                        <Box as='div' display='flex' mt='1.5rem'>
                            <Box as='div'>
                                ...
                                <Box as='input' type='number' step='0.5' min='0' max='24' name='daily-hours' fontWeight='500' backgroundColor='#FCFDFF' border='1px solid #E1E3E6' borderRadius='0.313rem' padding='0.5rem 1.5rem' width='100%' color='#5A5A66' mt='1rem' ></Box>
                            </Box>
                            ...
                            <Box as='div' ml='1.5rem'>
                                ...
                                <Box as='input' type='number' step='1' min='0' fontWeight='500' backgroundColor='#FCFDFF' border='1px solid #E1E3E6' borderRadius='0.313rem' padding='0.5rem 1.5rem' width='100%' color='#5A5A66' mt='1rem'></Box>
                            </Box>
                        </Box>
                    </Box>
                </Box>
